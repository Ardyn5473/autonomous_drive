...
詳細なセットアップ手順は[ドキュメント](https://autonomous-minicar-battle.github.io/togikaidrive-dev/setup/)を参照してください。
...
| nn | ニューラルネット（超音波） |
| donkeycar | CNN画像認識 |
| resnet18 / mobilevit_xxs / edgenext_xxsmall | 高度な画像認識 |
