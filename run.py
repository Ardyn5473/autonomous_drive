...
def reload_model():
    ...
    print("MODEL_DIR =", repr(config.MODEL_DIR))
    print("MODEL_NAME =", repr(config.MODEL_NAME))
    print("MODEL_PATH =", repr(os.path.join(config.MODEL_DIR, config.MODEL_NAME)))
    print("EXISTS =", os.path.exists(os.path.join(config.MODEL_DIR, config.MODEL_NAME)))
